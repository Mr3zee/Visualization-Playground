 ...
 * default grey canvas
 */
inline fun p5.print(vararg args: Any) {
    asDynamic().print(args)
}
 ...
 */
inline val p5.frameCount: Int get() = asDynamic().frameRate as Int
 ...
 */
inline val p5.deltaTime: Int get() = asDynamic().deltaTime as Int
 ...
 */
inline val p5.focused: Boolean get() = asDynamic().focused as Boolean
 ...
 */
inline fun p5.cursor(type: String, x: Double, y: Double) {
    asDynamic().cursor(type, x, y)
}

inline fun p5.cursor(type: String, x: Int, y: Int) {
    asDynamic().cursor(type, x, y)
}

inline fun p5.cursor(type: String) {
    asDynamic().cursor(type)
}
 ...
 */
inline fun p5.frameRate(fps: Int) {
    asDynamic().frameRate(fps)
}
 ...
 * @return {Number} current frameRate
 */
inline fun p5.getFrameRate(): Int = asDynamic().getFrameRate() as Int
 ...
 * @param {Number} [fps] number of frames to be displayed every second
 */
inline fun p5.setFrameRate(fps: Int) {
    asDynamic().setFrameRate(fps)
}
 ...
 */
inline val p5.displayWidth: Int get() = asDynamic().displayWidth as Int
 ...
 * This example does not render anything.
 */
inline val p5.displayHeight: Int get() = asDynamic().displayHeight as Int
 ...
 * This example does not render anything.
 */
inline val p5.windowWidth: Int get() = asDynamic().windowWidth as Int
 ...
 * This example does not render anything.
 */
inline val p5.windowHeight: Int get() = asDynamic().windowHeight as Int
 ...
 * @readOnly
 */
inline val p5.width: Int get() = asDynamic().width as Int
 ...
 * @readOnly
 */
inline val p5.height: Int get() = asDynamic().height as Int
 ...
 * This example does not render anything.
 */
inline fun p5.fullscreen(`val`: Boolean) {
    asDynamic().fullscreen(`val`)
}

inline fun p5.fullscreen(): Boolean = asDynamic().fullscreen() as Boolean
 ...
 */
inline fun p5.displayDensity(): Int = asDynamic().displayDensity() as Int
 ...
 */
inline fun p5.getURL(): String = asDynamic().getURL() as String
 ...
 * This example does not render anything.
 */
inline fun p5.getURLPath(): Array<String> = asDynamic().getURLPath() as Array<String>
 ...
 * This example does not render anything.
 */
inline fun p5.getURLParams(): dynamic = asDynamic().getURLParams()