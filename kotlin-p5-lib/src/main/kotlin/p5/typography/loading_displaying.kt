 ...
 * @param  {Function} [onSuccess] function to be executed after
 ...
 * p5*js in p5's theme dark pink
 */
inline fun p5.loadFont(
    path: String,
    noinline onSuccess: (p5.Font) -> Unit = {},
    noinline onError: (Exception) -> Unit = {}
): p5.Font = asDynamic().loadFont(path, onSuccess, onError).unsafeCast<p5.Font>()
 ...
 * @param {Number} [maxWidth] by default, the width of the text box,
 *                            see <a href="#/p5/rectMode">rectMode()</a> for more info
 * @param {Number} [maxHeight] by default, the height of the text box,
 *                            see <a href="#/p5/rectMode">rectMode()</a> for more info
 * @chainable
 * @example
 * <div>
 ...
 */
inline fun p5.text(str: Any?, x: Int, y: Int, maxWidth: Int? = undefined, maxHeight: Int? = undefined): p5 =
 ...
 *
 * @param {Object|String} [theFont] a font loaded via <a href="#/p5/loadFont">loadFont()</a>,
 ...
 * @param {Number} [theSize] the font size to use
 * @chainable
 *
 * @example
 * <div>
 ...
 */
inline fun p5.textFont(theFont: p5.Font, theSize: Int? = undefined): p5 = asDynamic().textFont(theFont, theSize) as p5

inline fun p5.textFont(theFont: String, theSize: Int? = undefined): p5 = asDynamic().textFont(theFont, theSize) as p5

inline fun p5.textFont(): p5.Font = asDynamic().textFont().unsafeCast<p5.Font>()
